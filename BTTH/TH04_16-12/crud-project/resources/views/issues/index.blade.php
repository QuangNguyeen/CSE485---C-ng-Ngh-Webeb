            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="delete" onclick="event.preventDefault(); if (confirm('Do you definitely want to delete this issue?')) { document.getElementById('delete-form-{{ $issue->id }}').submit(); }">
