...
<form action="{{ route('issues.store') }}" method="POST" style="margin: 50px 50px">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="reported_by" name="reported_by" placeholder="Enter reporter's name" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter issue description" required></textarea>
    </div>
    <div class="mb-3">
